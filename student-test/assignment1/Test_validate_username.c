...
void test_validate_my_username()
{
	...
	const char* confUsername = malloc_username_from_conf_file();
	TEST_ASSERT_EQUAL_STRING_MESSAGE(myUsername, confUsername, "Username from configuration file does not match the hard-coded username");
}
